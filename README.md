# Terraform Module for Slack Notifications on Stale GitLab Merge Requests
...
| <a name="input_gitlab_base_url"></a> [gitlab_base_url](#input_gitlab_base_url)                                                                      | Base URL for the GitLab API including 'https://'.                                                                                                                                          | `string`       | `"https://gitlab.com"`                    |    no    |
